...
import { pgTable, uuid, varchar, decimal, boolean, integer, timestamp, date, pgEnum } from "drizzle-orm/pg-core";

export const walletTypeEnum = pgEnum("wallet_type", ["basic", "credit", "saving", "linked"]);
export const categoryTypeEnum = pgEnum("category_type", ["income", "expense", "debt/loan"]);
export const transactionTypeEnum = pgEnum("transaction_type", ["income", "expense", "debt/load", "transfer"]);
