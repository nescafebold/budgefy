...
export default function SideNav() {
    return (
        <div className="w-full h-20 border flex flex-row md:flex-col md:h-screen md:rounded-2xl md:mx-2 bg-[#fffff9]">
            <div
            ...
            <div>
                <hr className="hidden md:block md:border-t-2 md:w-[90%] md:mx-auto" />
            </div>
            <div>
                <NavLinks />
            </div>
